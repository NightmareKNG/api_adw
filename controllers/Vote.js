...
module.exports.getVoteAllSortedByPointDescending = function getVoteAllSortedByPointDescending (req, res, next) {
  Vote.getVoteAllSortedByPointDescending()
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.getVoteByUser = function getVoteByUser (req, res, next, user_id) {
  Vote.getVoteByUser(user_id)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
